...
- Step 1: Write your configuration. You can refer to [sense workflow design document](./docs/workflow_design.md) or checkout the many example configration files ending with the `.sense` extension under the example directory.
- Step 2: Use thw tool to display its plan to either add or remove resources predicated upon the comparison of your declared infrastructure and the current state of existing resources.
- Step 3: Finally, you can accept planned changes to add or remove any infrastructure resources. Your infrastructure will then be ready to be fully deployed with the help of Terraform.
